	...
	var App = (function (_super) {
	    ...
	    App.prototype.renderDetail = function () {
	        if (this.state.detailInfo.taskId) {
	            ...
	            return React.createElement(tag_detail_1.TagDetailComponent, { tag: tag, eventsById: this.state.eventsById, closeCallback: this.closeDetail.bind(this) });
	        }
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TaskBoardComponent = (function (_super) {
	    ...
	    TaskBoardComponent.prototype.divideByType = function (tasksById, type, selectedTag) {
	        ...
	        for (var _c = 0, _d = Object.keys(tasksById); _c < _d.length; _c++) {
	            var taskId = _d[_c];
