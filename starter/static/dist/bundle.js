...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = (function (_super) {
	    ...
	    App.prototype.updateTaskToEventsAfterNewEvent = function (newEvent) {
	        ...
	        var newTaskMap = {};
	        for (var _d = 0, _e = newEvent.taskIds; _d < _e.length; _d++) {
	            var taskId = _e[_d];
	    ...
	    App.prototype.createEvent = function (event) {
	        ...
	        jQuery.post('/api/1/event/create', event, function (newEventJson) {
	            ...
	            _this.updateTaskToEventsAfterNewEvent(newEvent);
	            _this.setState(_this.state);
	        });
	    };
	    App.prototype.updateEvent = function (event) {
	        ...
	        jQuery.post('/api/1/event/update', event, function (updatedEventJson) {
	            ...
	            App.updateEventsById(_this.state);
	            _this.updateTaskToEventsAfterNewEvent(updatedEvent);
	            _this.setState(_this.state);
	        });
	    };
	...
	var TaskDetailComponent = (function (_super) {
	    ...
	    TaskDetailComponent.prototype.renderHeader = function () {
	        return React.createElement("div", { className: "task-detail-header" },
	            React.createElement("div", { className: "id-and-options" },
	                "T",
	                this.props.task.id,
	                this.renderOptions()),
	    ...
	    TaskDetailComponent.prototype.render = function () {
	        return React.createElement("div", { className: "task-detail-container" },
	            this.renderHeader(),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CalendarComponent = (function (_super) {
	    ...
	    CalendarComponent.prototype.componentDidMount = function () {
	        ...
	        document.addEventListener(events_1.signalCreateEventWithTask, function (e) {
	            var t = e.detail;
	            if (_this.shouldCreateEventWithTask()) {
	                var now = moment();
	                _this.state.createEventTimestamp = now.unix() * 1000;
	                ...
	                _this.state.createEventDurationSecs = x.startOf("minute").unix() - now.unix();
	                _this.state.showCreate = true;
	                _this.state.createEventTask = t;
	                _this.setState(_this.state);
	            }
	        });
	        document.addEventListener(events_1.signalEndEventWithTask, function (e) {
	            var t = e.detail;
	            var event = _this.shouldEndEventWithTask(t);
	            if (event) {
	                event.durationSecs = Math.floor((moment().unix() * 1000 - event.startTime) / 1000);
	                _this.props.updateEvent(event);
	            }
	        });
	    };
